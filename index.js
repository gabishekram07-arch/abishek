...
var _processInput = Module['_processInput'] = makeInvalidEarlyAccess('_processInput');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['processInput'] != 'undefined', 'missing Wasm export: processInput');
  ...
  _processInput = Module['_processInput'] = createExportWrapper('processInput', 1);
